...
<template>
  ...
  <form @submit.prevent="submitCommitteeForm" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label for="file" class="form-label text-dark fw-bold text-uppercase">File</label>
      <input
        type="file"
        name="file"
        id="file"
    ...
    <div class="form-group mt-3">
      <label
        for="lead_committee"
        class="form-label required text-dark text-uppercase fw-bold"
    ...
    <div class="form-group mt-3">
      <label for="expanded_committee" class="form-label text-dark fw-bold text-uppercase"
    ...
    <div class="form-group mt-3" v-auto-animate>
      <label for="name" class="form-label required text-dark fw-bold text-uppercase"
        >Name</label
      >
      <input
        id="name"
...
<style scoped>
/* override the default style border of v-select */
.v-select {
