          ...
          <div class="card-header p-0 d-flex justify-content-between align-items-center">
            ...
            <div>
              <button
                ...
                class="btn btn-dark fw-medium text-uppercase"
              >
                <i class="mdi mdi-plus-circle-outline"></i>
                Add New Legislation Type
              </button>
            </div>
          </div>
                ...
                <form method="POST" @submit.prevent="submitType">
                  <div class="form-group">
                    ...
                    <div class="form-group float-end mt-2">
                      <button class="btn btn-warning me-1" @click="closeForm">
                        Close
                      </button>
            ...
            <table class="table border">
              <thead>
                <tr class="bg-dark">
                  ...
                  <th
                    class="border text-white bg-dark border-dark text-uppercase text-center"
                  >
                    Created At
                  </th>
                  <th
              ...
              <tbody>
                <tr v-for="type in types.data" :key="type">
                  ...
                  <td class="text-center">
                    {{ moment(type.updated_at).format("MM/DD/YYYY hh:mm A") }}
                  </td>
                  <td class="text-center">
                    <a
                      @click="editType(type)"
