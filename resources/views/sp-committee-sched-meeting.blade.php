...
<body class="home-template">
    ...
    <script>
        ...
        document.querySelector('#increase-font-size').addEventListener('click', function() {
            let styles = window.getComputedStyle(document.querySelector('*'));
            let currentFontSize = parseFloat(styles.fontSize);
        ...
        document.querySelector('#decrease-font-size').addEventListener('click', function() {
            let styles = window.getComputedStyle(document.querySelector('*'));
            let currentFontSize = parseFloat(styles.fontSize);
            let newFontSize = currentFontSize - 1;
            document.documentElement.style.fontSize = newFontSize + 'px';
        ...
        document.querySelector('#reset').addEventListener('click', function() {
            clearLocalStorageItems(["fontSize", "fullscreen", "isSidebarOpen"]);
            location.reload();
        });
