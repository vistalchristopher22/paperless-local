                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('committee.invited-guest.create', $record?->screen_displayable?->id) }}"
                                                target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        @if ($record->status !== \App\Enums\ScreenDisplayStatus::ON_GOING->value)
                                            ...
                                            @if ($record->status !== \App\Enums\ScreenDisplayStatus::NEXT->value)
                                                <li>
                                                    <a href="#" class="dropdown-item btn-set-next"
                                                        data-record="{{ $record }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor"
